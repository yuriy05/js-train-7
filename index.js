...
function createAndCompareTwoSymbols(value) {
  ...
  let mySymbolOne = Symbol(value);
  let mySymbolTwo = Symbol(value);
  return mySymbolOne === mySymbolTwo;
}
...
function getSymbolKey(symbol) {
  ...
  let getSymbol = Symbol.keyFor(symbol);
  return getSymbol;
}
...
function useSymbolToStringTag() {
  ...
  let myObject = {};
  let mySymbol = Symbol("CustomObject");
  myObject[mySymbol] = mySymbol.description;
  return myObject[mySymbol];
}
...
function useSymbolDescription() {
  ...
  let mySymbol = Symbol("mySymbol"); //! Створив змінну та присвоїв їй символ із описом
  let symbolDescription = mySymbol.description; //! Створив змінну та присвоїв їй значення опису мого символу
  return symbolDescription; //! Повернув результат функції, а саме опис символа
}
